...
LICENSE: [MIT](/task_4.1/license.md)
...
1. [Первоначальная настройка Git](initial_settings.md)
2. [git init](init.md)
...
8. [git log](log.md)
9. [git push](push.md)
10. [git switch](switch.md)
11. [git branch](branch.md)
12. [git push origin](push_origin.md)
13. [git merge](merge.md)
14. [git rebase](rebase.md)
15. [git cherry-pick](cherry-pick.md)
